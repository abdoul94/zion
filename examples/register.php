        ...
        <div class="col-lg-6 col-md-8">
          <div class="card bg-secondary shadow border-0">
            <div class="card-header bg-transparent pb-5">
              <div class="text-muted text-center mt-2 mb-4"><small>Add Tutor </small></div>
...
include('connect.php');
	...
	if($_REQUEST)
	{
		...
		$sql = "INSERT INTO admindata (admin_name, admin_age, admin_mobile, admin_email)VALUES ('$name', '$age', '$mobile', '$email')";
