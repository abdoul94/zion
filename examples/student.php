        ...
        <div class="col-lg-6 col-md-8">
          <div class="card bg-secondary shadow border-0">
            <div class="card-header bg-transparent pb-5">
              <div class="text-muted text-center mt-2 mb-4"><small>Add Student </small></div>
...
include('connect.php');
	...
	if($_REQUEST)
	{
		...
		$sql = "INSERT INTO studentdata (st_name, age, st_email, st_mobile)VALUES ('$name', '$age', '$email', '$mobile')";
